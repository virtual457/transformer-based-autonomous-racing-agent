...
Run command:
    .\\AssetoCorsa\\Scripts\\python.exe gym/transformer_sac_vectorq_v2_final_fineTune/train.py --epochs 3
"""
...
SAC_HYPERPARAMS = {
    ...
    "gamma":          0.992,
    "tau":            0.005,
    "target_entropy": [-2.0, -3.0, -3.0],   # [steer, throttle, brake]
}
...
def main():
    ...
    # ── Replay buffer ────────────────────────────────────────────────────────
    from transformer_sac_vectorq_v2_final_fineTune.replay_buffer import (
