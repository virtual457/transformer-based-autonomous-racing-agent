...
Run command:
    .\\AssetoCorsa\\Scripts\\python.exe gym/transformer_sac_vectorq_v2_final_fineTune/collect.py --manage-ac --phases 1
"""
...
def main():
    ...
    work_dir    = os.path.join(_THIS_DIR, '..', '..', 'outputs', 'transformer_sac_vectorq_v2_final_fineTune')
    ...
    from transformer_sac_vectorq_v2_final_fineTune.agent import FinetuneAgent
