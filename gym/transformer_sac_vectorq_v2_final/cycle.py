...
Run:
    .\\AssetoCorsa\\Scripts\\python.exe gym/transformer_sac_vectorq_v2_final/cycle.py
    .\\AssetoCorsa\\Scripts\\python.exe gym/transformer_sac_vectorq_v2_final/cycle.py --cycles 20 --collect-episodes 8 --train-epochs 3 --backup-every 5
"""
